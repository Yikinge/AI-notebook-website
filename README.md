...
*(上传至 GitHub 后，你可以将截图或录屏 GIF 放在这里，让访客第一时间感受到视觉震撼)*

- **主界面 & 粒子交互**
  > `[请在这里放置一张主界面的截图：包含上传按钮和星空背景]`
  > `[请在这里放置一张 GIF：展示鼠标划过图片粒子时的排斥效果]`

- **音乐律动**
  > `[请在这里放置一张 GIF：展示开启电台后粒子随音乐跳动的效果]`

- **AI 对话**
  > `[请在这里放置一张截图：展示右侧聊天框与底部悬浮字幕]`
